package com.maurasoftware.castle;
...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private EditText mRegistrationPasswordView;
    private EditText mRegistrationPasswordReenterView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRegisterEmailView = (AutoCompleteTextView) findViewById(R.id.registration_email);
        ...
        mRegistrationPasswordView = (EditText) findViewById(R.id.registration_password);
        mRegistrationPasswordReenterView = (EditText) findViewById(R.id.registration_password_reenter);
        ...
        Button mEmailRegisterButton = (Button) findViewById(R.id.registration_button);
        ...
        // Define click listeners for Login/Register tabs
        final TextView mLoginTab = (TextView) findViewById(R.id.login_tab);
        final TextView mRegisterTab = (TextView) findViewById(R.id.register_tab);
