...
app.config(function ($mdIconProvider) {
    ...
    $mdIconProvider
        .icon('menu', './bower_components/mdicons/ic_menu_48px.svg')
        .icon('new_report', './bower_components/mdicons/ic_assignment_48px.svg')
        .icon('book', './bower_components/mdicons/ic_book_48px.svg')
        .icon('account', './bower_components/mdicons/ic_account_box_48px.svg')
        .icon('image', './bower_components/mdicons/ic_image_48px.svg')
        .icon('clear', './bower_components/mdicons/ic_clear_48px.svg')
        .icon('camera', './bower_components/mdicons/ic_camera_48px.svg')
        .icon('cancel','./bower_components/mdicons/ic_cancel_48px.svg')
        .icon('add','./bower_components/mdicons/ic_add_48px.svg')
        .icon('remove','./bower_components/mdicons/ic_remove_48px.svg')
        .icon('close','./bower_components/mdicons/ic_close_48px.svg')
        .icon('back','./bower_components/mdicons/ic_arrow_back_48px.svg')
        .icon('more_vert','./bower_components/mdicons/ic_more_vert_48px.svg')
        .icon('more_horiz','./bower_components/mdicons/ic_more_horiz_48px.svg')
        .icon('account_circle','./bower_components/mdicons/ic_account_circle_48px.svg')
        .icon('rrAdd','./bower_components/mdicons/ic_playlist_add_48px.svg')
        .icon('rrEdit','./bower_components/mdicons/ic_playlist_add_check_48px.svg')
        .icon('chevron_right','./bower_components/mdicons/ic_chevron_right_48px.svg')
        .icon('check','./bower_components/mdicons/ic_check_48px.svg')
        .icon('check_box','./bower_components/mdicons/ic_check_box_48px.svg')
        .icon('check_box_outline','./bower_components/mdicons/ic_check_box_outline_48px.svg')
        .icon('radio_button_checked','./bower_components/mdicons/ic_radio_button_checked_48px.svg')
        .icon('radio_button_unchecked','./bower_components/mdicons/ic_radio_button_unchecked_48px.svg')
        .icon('build','./bower_components/mdicons/ic_build_48px.svg')
        .icon('switch_camera','./bower_components/mdicons/ic_switch_camera_48px.svg')
        .icon('crop_free','./bower_components/mdicons/ic_crop_free_48px.svg')
        .icon('add_to_photos','./bower_components/mdicons/ic_add_to_photos_48px.svg')
        .icon('delete', './bower_components/mdicons/ic_delete_48px.svg')
        .icon('clear_selection', './bower_components/mdicons/ic_settings_backup_restore_48px.svg')
        .icon('new_report_folder', './bower_components/mdicons/ic_create_new_folder_48px.svg')
        .icon('reverse', './bower_components/mdicons/ic_swap_vertical_circle_48px.svg')
        .icon('sort', './bower_components/mdicons/ic_sort_48px.svg')
        .icon('check_box', './bower_components/mdicons/ic_check_box_48px.svg')
        .icon('check_box_outline_blank', './bower_components/mdicons/ic_check_box_outline_blank_48px.svg')
        .icon('expand_more', './bower_components/mdicons/ic_expand_more_48px.svg')
        .icon('add_circle_outline', './bower_components/mdicons/ic_add_circle_outline_48px.svg')
        .icon('keyboard_arrow_right', './bower_components/mdicons/ic_keyboard_arrow_right_48px.svg')
        .icon('keyboard_arrow_down', './bower_components/mdicons/ic_keyboard_arrow_down_48px.svg')
        .icon('keyboard_arrow_up', './bower_components/mdicons/ic_keyboard_arrow_up_48px.svg')
        .icon('mode_edit', './bower_components/mdicons/ic_mode_edit_48px.svg')
        .icon('arrow_drop_down_circle', './bower_components/mdicons/ic_arrow_drop_down_circle_48px.svg')
        .icon('arrow_drop_down', './bower_components/mdicons/ic_arrow_drop_down_48px.svg')
        .icon('subject', './bower_components/mdicons/ic_subject_48px.svg')
        .icon('today', './bower_components/mdicons/ic_today_48px.svg')
        .icon('watch_later', './bower_components/mdicons/ic_watch_later_48px.svg')
        .icon('iso', './bower_components/mdicons/ic_iso_48px.svg')
        .icon('error', './bower_components/mdicons/ic_error_48px.svg')
        .icon('short_text', './bower_components/mdicons/ic_short_text_48px.svg')
        .icon('work', './bower_components/mdicons/ic_work_48px.svg')
        .icon('looks_one', './bower_components/mdicons/ic_looks_one_48px.svg')
        .icon('clear_all', './bower_components/mdicons/ic_clear_all_48px.svg')
        ;
});
