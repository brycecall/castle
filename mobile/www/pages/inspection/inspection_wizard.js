...
app.controller('inspection_wizard', function ($rootScope, $scope, $, $state, header_manager, camera_manager, action_manager, inspection_manager, theme_manager ,$transition$, shareService, $timeout, $mdDialog, $mdToast) {
  ...
  // Replace the default severity list with the list from the theme
  theme_manager.getThemeMetadata($scope.inspection.insThemeId).then(
    function (data) {
      if (data.classifications) {
        $scope.severityList = data.classifications;
      }
    }
  );
